...
import vtkCropWidget from 'rediminds-cta/src/vtk/CropWidget';
import vtkAngleWidget from 'rediminds-cta/src/vtk/AngleWidget';
import vtkDistance2DWidget from 'rediminds-cta/src/vtk/Distance2DWidget';
import vtkTextWidget from 'rediminds-cta/src/vtk/TextWidget';
import vtkPaintWidget from '@kitware/vtk.js/Widgets/Widgets3D/PaintWidget';

import vtkCustomSliceRepresentationProxy from 'rediminds-cta/src/vtk/CustomSliceRepresentationProxy';
import vtkCustomVolumeRepresentationProxy from 'rediminds-cta/src/vtk/CustomVolumeRepresentationProxy';
import vtkLabelMapVolumeRepProxy from 'rediminds-cta/src/vtk/LabelMapVolumeRepProxy';
import vtkLabelMapSliceRepProxy from 'rediminds-cta/src/vtk/LabelMapSliceRepProxy';
import vtkWidgetProxy from 'rediminds-cta/src/vtk/WidgetProxy';
...
import ConfigUtils from 'rediminds-cta/src/config/configUtils';

import proxyUI from 'rediminds-cta/src/config/proxyUI';
import proxyLinks from 'rediminds-cta/src/config/proxyLinks';
import proxyViewRepresentationMapping from 'rediminds-cta/src/config/proxyViewRepresentationMapping';
