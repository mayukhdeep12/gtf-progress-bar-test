...
import GirderProvider from 'rediminds-cta/src/girder';
...
import 'rediminds-cta/static/global.css';

// side-effect: register readers
import 'rediminds-cta/src/io/ParaViewGlanceReaders';
// side-effect: register presets
import 'rediminds-cta/src/config/ColorMaps';

import ReaderFactory from 'rediminds-cta/src/io/ReaderFactory';
import App from 'rediminds-cta/src/components/core/App';
import Config from 'rediminds-cta/src/config';
import createStore from 'rediminds-cta/src/store';
import { ProxyManagerVuePlugin } from 'rediminds-cta/src/plugins';
import Settings from 'rediminds-cta/src/settings';
